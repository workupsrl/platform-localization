...
<section class="panel panel-default panel-grid">
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="actions">
					...
					<ul class="nav navbar-nav navbar-left">
						...
						<li class="primary">
							<a href="{{ route('admin.localization.locales.translations.create') }}" data-toggle="tooltip" data-original-title="{{{ trans('action.create') }}}">
					...
					{{-- Grid: Filters --}}
					<form class="navbar-form navbar-right" method="post" accept-charset="utf-8" data-search data-grid="translation" role="form">
						...
						<div class="input-group">
							...
							<span class="input-group-btn">
								...
								<ul class="dropdown-menu" role="menu">
									...
									<li>
										<a data-grid="translation" data-filter="enabled:1" data-label="enabled::{{{ trans('common.all_enabled') }}}" data-reset>
											<i class="fa fa-eye"></i> {{{ trans('common.show_enabled') }}}
										</a>
									</li>

									<li>
										<a data-toggle="tooltip" data-placement="top" data-original-title="" data-grid="translation" data-filter="enabled:0" data-label="enabled::{{{ trans('common.all_disabled') }}}" data-reset>
	...
	<div class="table-responsive">
		...
		<table id="data-grid" class="table table-hover" data-source="{{ route('admin.localization.locales.translations.grid', array($locale->id)) }}" data-grid="translation">
			<thead>
				<tr>
					<th><input data-grid-checkbox="all" type="checkbox"></th>
                    <th class="sortable" data-sort="id">{{{ trans('stevebauman/localization::translations/model.general.id') }}}</th>
                    <th class="sortable" data-sort="code">{{{ trans('stevebauman/localization::translations/model.general.translation') }}}</th>
					<th class="sortable" data-sort="created_at">{{{ trans('stevebauman/localization::translations/model.general.created_at') }}}</th>
				</tr>
			</thead>
			<tbody></tbody>
		</table>
