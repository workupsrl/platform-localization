...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'locale');

		$('.daterangepicker_end_input').attr('data-grid', 'locale');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('locale', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
	};
