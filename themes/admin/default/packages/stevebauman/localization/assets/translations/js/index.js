...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'translation');

		$('.daterangepicker_end_input').attr('data-grid', 'translation');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('translation', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
	};
